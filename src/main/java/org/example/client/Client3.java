        ...
        while(n!=6) {
            ...
            switch (n) {
                ...
                case 2:
                    ...
                    ClientRegistrationResponse clientRegistrationResponse = blockingStub.joinServer(ClientRegistrationRequest.newBuilder().setClientId(3).build());
                ...
                case 3:
                    ...
                    ClientRegistrationResponse clientRegistrationResponse_leave = blockingStub1.leaveServer(ClientRegistrationRequest.newBuilder().setClientId(3).build());
                ...
                case 4 :
                    ...
                    ArticleResponse articleResponse=  blockingStub2.getArticles(ArticleRequest.newBuilder().setClientId(3).setType(type).setDate(date).setAuthor(author).build());
                ...
                case 5 :
                    ...
                    PublishArticleResponse publishArticleResponse=  blockingStub3.publishArticle(PublishArticleRequest.newBuilder().setClientId(3).setArticle(article1).build());
