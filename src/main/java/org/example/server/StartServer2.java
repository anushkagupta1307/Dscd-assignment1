        ...
        while (n != 3) {
            ...
            switch (n) {
                ...
                case 2:
                    ...
                    System.out.println("All Articles on Server 2 before adding " + Server.allArticles.size());
                    Server.allArticles.addAll(articlesRetrieved);
                    System.out.println("All Articles on Server 2 after adding " + Server.allArticles.size());
                    break;
            }
        }
    }
